...
| --- | --- | ---: | ---: | ---: | ---: | ---: | ---: | --- |
| 调度策略 | FIFO | 30 | 316.833 | 75.998 | 303.991 | 152.523 | 0.000 | |
| 调度策略 | resource-aware | 30 | 324.257 | 74.235 | 323.851 | 139.844 | 0.000 | |
| 上下文优化 | full-context | 30 | 38.539 | 778.541 | 0.783 | 0.000 | 0.000 | |
| 上下文优化 | reuse+compression | 30 | 20.019 | 1498.928 | 0.723 | 0.000 | 0.000 | |
| 容错策略 | no-recovery | 30 | 3.646 | 8232.967 | 0.051 | 0.000 | 0.000 | |
| 容错策略 | retry | 30 | 3.411 | 8800.672 | 0.048 | 0.000 | 0.000 | |
| 容错策略 | fallback | 30 | 4.243 | 7072.626 | 0.076 | 0.000 | 1.000 | |
